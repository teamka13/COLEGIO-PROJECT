          ...
          <div className="w-auto">
            ...
            <div className="relative flex items-center h-10">
              ...
              <DatePicker
                ...
                className="pl-10 pr-3 py-2 h-10 w-48 border border-gray-300 rounded-md "
          ...
          <div className="w-auto">
            ...
            <div className="relative flex items-center h-10">
              ...
              <select
                ...
                className="pl-10 pr-8 py-2 h-10 w-48 border border-gray-300 rounded-md appearance-none"
              >
