              ...
              <tr>
                {Object.keys(currentData[0])
                  ...
                  .map((key) => (
                    <th
                      key={key}
                      className="px-6 py-3 text-left text-sm font-semibold text-orange-800 uppercase tracking-wider"
                    >
                      {key}
                    </th>
                  ))}
    ...
    <div className="p-6 mt-6 max-w-7xl mx-auto bg-gray-200 rounded-lg shadow-lg shadow-gray-800">
      ...
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center">
          <Search className="text-orange-600 mr-3 h-6 w-6" />
      ...
      <div className="flex flex-wrap items-center  gap-4 mb-6">
        ...
        <input
          ...
          className="p-3 border-2 border-orange-300 rounded-lg w-full focus:outline-none focus:ring-2 
          focus:ring-orange-500 focus:ring-offset-2 active:scale-97 active:shadow-inner active:opacity-90 transition-all duration-300"
          value={search}
        ...
        <select
          ...
          className="h-10 w-40  text-center bg-white  rounded-md shadow-sm hover:bg-gray-100  
            focus:ring-orange-600  focus:outline-none focus:ring-2  focus:ring-offset-2 active:scale-95 active:shadow-inner active:opacity-90 transition-all duration-300"
        >
