  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-xl mt-6 bg-gray-100 rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 shadow-black">
        ...
        <div className="h-4 bg-gradient-to-r from-green-500 from-35% to-amber-600"></div>

        {/* Contenedor de logos */}
        <div className="flex justify-around items-center px-10 pt-8">
          <img
            src="/images/BACHILLER.png"
            alt="Logo BACHILLER"
            className="h-25 object-contain opacity-90 hover:opacity-100 transition-opacity"
          />
          <img
            src="/images/NL.png"
            alt="Logo NL"
        ...
        <div className="px-10 py-8">
          ...
          <div className="relative mb-8">
            <input
              ...
              className="w-full px-6 py-4 text-xl border-2 border-gray-300 rounded-xl focus:ring-3 focus:ring-green-600 focus:border-green-600 outline-none transition-all text-center font-mono uppercase placeholder-gray-400"
              disabled={isLoading}
            />
            {isLoading && (
