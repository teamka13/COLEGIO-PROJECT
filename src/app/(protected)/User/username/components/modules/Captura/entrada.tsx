        ...
        <div className="px-10 py-8">
          ...
          <div className="relative mb-8">
            <input
              ...
              className="w-full px-6 py-4 text-xl border-2 border-gray-300 rounded-xl focus:ring-3 focus:ring-amber-400 focus:border-amber-400 outline-none transition-all text-center font-mono uppercase placeholder-gray-400"
              disabled={isLoading}
            />
            {isLoading && (
