  ...
  return (
    ...
    >
      ...
      <div className="relative w-full mt-6 max-w-xl bg-gray-100 rounded-2xl shadow-2xl overflow-hidden transition-all duration-300 shadow-black ">
        ...
        <div className="h-4 bg-gradient-to-r from-blue-500 to-sky-950"></div>
        ...
        <div className="px-10 py-8">
          ...
          <div className="relative mb-8">
            <input
              ...
              className="w-full px-6 py-4 text-xl border-2 border-gray-300 rounded-xl focus:ring-3 focus:ring-sky-700 focus:border-Skyring-sky-700 outline-none transition-all text-center font-mono uppercase placeholder-gray-400"
              disabled={isLoading}
            />
            {isLoading && (
