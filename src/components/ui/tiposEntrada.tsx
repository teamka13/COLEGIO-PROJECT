...
export const RegistroExitoso = (props: PropsQuery) => (
  <BaseCard className="w-full max-w-xl mx-auto px-6 py-4 bg-blue-100 rounded-lg text-gray-800">
...
export const RegistroTarde = (props: PropsQuery) => (
  <BaseCard className="w-full max-w-xl mx-auto px-6 py-4 bg-yellow-100 border border-yellow-200 rounded-lg text-gray-800">
    <div className="grid grid-cols-2 gap-y-2">
      <span className="font-medium">Matrícula:</span>{" "}
      <span>{props.Matricula}</span>
      <span className="font-medium">Nombre:</span> <span>{props.Nombre}</span>
...
export const SalidaExitosa = (props: PropsQuery) => (
  <BaseCard className="w-full max-w-xl mx-auto  px-6 py-4 bg-green-100 rounded-lg text-gray-800">
    <div className="grid grid-cols-2 gap-y-2">
      <span className="font-medium">Matrícula:</span>{" "}
      <span>{props.Matricula}</span>
      <span className="font-medium">Nombre:</span> <span>{props.Nombre}</span>
